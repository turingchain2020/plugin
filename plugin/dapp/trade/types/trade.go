...
//NewType ...
func NewType(cfg *types.TuringchainConfig) *TradeType {
	c := &TradeType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawTradeSellTx(cfg *types.TuringchainConfig, parm *TradeSellTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &TradeForSell{
...
func CreateRawTradeBuyTx(cfg *types.TuringchainConfig, parm *TradeBuyTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeRevokeTx(cfg *types.TuringchainConfig, parm *TradeRevokeTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeBuyLimitTx(cfg *types.TuringchainConfig, parm *TradeBuyLimitTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &TradeForBuyLimit{
...
func CreateRawTradeSellMarketTx(cfg *types.TuringchainConfig, parm *TradeSellMarketTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawTradeRevokeBuyTx(cfg *types.TuringchainConfig, parm *TradeRevokeBuyTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
