...
var optV2 = &table.Option{
	...
	Index: []string{
		...
		// https://chain.__officeSite__/document/105 文档1.8 sell & asset-price & status, order by price
		// https://chain.__officeSite__/document/105 文档1.3 buy  & asset-price & status, order by price
