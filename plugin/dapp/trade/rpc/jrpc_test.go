...
func newTestTuringchain() (*mocks.QueueProtocolAPI, *Jrpc) {
...
func TestTuringchain_CreateRawTradeSellTx(t *testing.T) {
	_, client := newTestTuringchain()
...
func TestTuringchain_CreateRawTradeBuyTx(t *testing.T) {
	_, client := newTestTuringchain()
	var testResult interface{}
...
func TestTuringchain_CreateRawTradeRevokeTx(t *testing.T) {
	_, client := newTestTuringchain()
	var testResult interface{}
...
func TestTuringchain_CreateRawTradeBuyLimitTx(t *testing.T) {
	_, client := newTestTuringchain()
	var testResult interface{}
...
func TestTuringchain_CreateRawTradeSellMarketTx(t *testing.T) {
	_, client := newTestTuringchain()
	var testResult interface{}
...
func TestTuringchain_CreateRawTradeRevokeBuyTx(t *testing.T) {
	_, client := newTestTuringchain()
	var testResult interface{}
...
func TestTuringchain_GetLastMemPoolOk(t *testing.T) {
	api, testTuringchain := newTestTuringchain()
	cfg := api.GetConfig()
