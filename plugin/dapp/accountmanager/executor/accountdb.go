...
import (
	...
	tab "github.com/turingchain2020/turingchain/common/db/table"
...
func getManagerAddr(cfg *types.TuringchainConfig, db dbm.KV, key, defaultValue string) string {
	var item types.ConfigItem
	value, err := getManageKey(cfg, key, db)
	if err != nil {
		return defaultValue
...
func queryBalanceByID(statedb, localdb dbm.KV, cfg *types.TuringchainConfig, execName string, in *et.QueryBalanceByID) (*et.Balance, error) {
