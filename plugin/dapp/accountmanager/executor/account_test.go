...
import (
	...
	et "github.com/turingchain2020/plugin/plugin/dapp/accountmanager/types"
...
func TestAccountManager(t *testing.T) {
	...
	//转账
	tx4, err := CreateTransfer(&et.Transfer{FromAccountID: "harrylee2015", ToAccountID: "harrylee2020", Asset: &types.Asset{Exec: "coins", Symbol: "trc", Amount: 1e8}}, PrivKeyB)
	assert.Equal(t, err, nil)
	...
	err = Exec_Block(t, stateDB, kvdb, env, tx6)
	assert.Nil(t, err)
	tx7, _ := CreateTransfer(&et.Transfer{FromAccountID: "harrylee2015", ToAccountID: "harrylee2015", Asset: &types.Asset{Exec: "coins", Symbol: "trc", Amount: 1e8}}, PrivKeyD)

	err = Exec_Block(t, stateDB, kvdb, env, tx7)
	assert.Equal(t, err, nil)
	balance, err := Exec_QueryBalanceByID(&et.QueryBalanceByID{AccountID: "harrylee2015", Asset: &types.Asset{Symbol: "trc", Exec: "coins"}}, stateDB, kvdb)
	assert.Equal(t, err, nil)
