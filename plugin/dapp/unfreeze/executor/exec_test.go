...
import (
	...
	pty "github.com/turingchain2020/plugin/plugin/dapp/unfreeze/types"
...
func init() {
	Init(pty.UnfreezeX, turingchainTestCfg, nil)
}
...
func TestUnfreeze(t *testing.T) {
	...
	accB, _ := account.NewAccountDB(turingchainTestCfg, AssetExecPara, Symbol, stateDB)
	accB.SaveExecAccount(execAddr, &accountB)

	env := execEnv{
		10,
		turingchainTestCfg.GetDappFork(pty.UnfreezeX, pty.ForkUnfreezeIDX),
		1539918074,
	}
	ty := pty.UnfreezeType{}
	ty.SetConfig(turingchainTestCfg)
