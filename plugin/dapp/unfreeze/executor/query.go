...
func QueryWithdraw(cfg *types.TuringchainConfig, stateDB dbm.KV, id string) (types.Message, error) {
...
func getWithdrawAvailable(cfg *types.TuringchainConfig, unfreeze *pty.Unfreeze, calcTime int64) (int64, error) {
