...
func testPublishEventRawCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testAbortEventRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testPrePublishResultRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testAbortPrePubResultRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
	payload := &oty.EventAbort{EventID: "123"}
	params := &rpctypes.CreateTxIn{
		Execer:     cfg.ExecName(oty.OracleX),
...
func testPublishResultRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
	payload := &oty.ResultPrePublish{
		EventID: "123",
		Source:  "新浪体育",
		Result:  "{\"team1\":3, \"team2\":2}",
