...
// NewType method
func NewType(cfg *types.TuringchainConfig) *CollateralizeType {
	c := &CollateralizeType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawCollateralizeCreateTx(cfg *types.TuringchainConfig, parm *CollateralizeCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeBorrowTx(cfg *types.TuringchainConfig, parm *CollateralizeBorrowTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeRepayTx(cfg *types.TuringchainConfig, parm *CollateralizeRepayTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeAppendTx(cfg *types.TuringchainConfig, parm *CollateralizeAppendTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeFeedTx(cfg *types.TuringchainConfig, parm *CollateralizeFeedTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeRetrieveTx(cfg *types.TuringchainConfig, parm *CollateralizeRetrieveTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawCollateralizeManageTx(cfg *types.TuringchainConfig, parm *CollateralizeManageTx) (*types.Transaction, error) {
	if parm == nil {
