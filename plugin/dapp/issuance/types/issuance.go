...
// NewType method
func NewType(cfg *types.TuringchainConfig) *IssuanceType {
	c := &IssuanceType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawIssuanceCreateTx(cfg *types.TuringchainConfig, parm *IssuanceCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceDebtTx(cfg *types.TuringchainConfig, parm *IssuanceDebtTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceRepayTx(cfg *types.TuringchainConfig, parm *IssuanceRepayTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceFeedTx(cfg *types.TuringchainConfig, parm *IssuanceFeedTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceCloseTx(cfg *types.TuringchainConfig, parm *IssuanceCloseTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawIssuanceManageTx(cfg *types.TuringchainConfig, parm *IssuanceManageTx) (*types.Transaction, error) {
	if parm == nil {
