...
import (
	...
	pty "github.com/turingchain2020/plugin/plugin/dapp/pokerbull/types"
...
func testContinueRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testPlayRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testQuitRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
