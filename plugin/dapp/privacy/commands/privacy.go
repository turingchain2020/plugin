...
import (
	...
	cmdtypes "github.com/turingchain2020/turingchain/system/dapp/commands/types"
...
func createPub2PrivTxFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("symbol", "s", "TRC", "asset symbol, default TRC")
...
func addListPrivacyTxsFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("exec", "e", "coins", "asset executor(coins, token, paracross), default coins")
	cmd.Flags().StringP("symbol", "s", types.TRC, "asset sysmbol.(TRC default)")
