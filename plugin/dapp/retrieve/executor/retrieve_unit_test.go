...
import (
	...
	rt "github.com/turingchain2020/plugin/plugin/dapp/retrieve/types"
)
...
func constructRetrieveInstance() drivers.Driver {
	cfgstring := strings.Replace(types.GetDefaultCfgstring(), "Title=\"local\"", "Title=\"turingchain\"", 1)
	chainTestCfg := types.NewTuringchainConfig(cfgstring)
