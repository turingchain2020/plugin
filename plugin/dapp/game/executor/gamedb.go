...
func List(cfg *types.TuringchainConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
	return QueryGameListByPage(cfg, db, stateDB, param)
}

// QueryGameListByPage 分页查询
func QueryGameListByPage(cfg *types.TuringchainConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
...
func queryGameListByStatusAndAddr(cfg *types.TuringchainConfig, db dbm.Lister, stateDB dbm.KV, param *gt.QueryGameListByStatusAndAddr) (types.Message, error) {
	direction := ListDESC
...
func getConfValue(cfg *types.TuringchainConfig, db dbm.KV, key string, defaultValue int64) int64 {
...
func getManageKey(cfg *types.TuringchainConfig, key string, db dbm.KV) ([]byte, error) {
