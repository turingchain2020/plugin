...
//也就是说，我们可以构造其他平行链的交易
func getRealExecName(cfg *types.TuringchainConfig, paraName string) string {
	return cfg.ExecName(paraName + GameX)
}

// NewType  new type
func NewType(cfg *types.TuringchainConfig) *GameType {
	c := &GameType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawGamePreCreateTx(cfg *types.TuringchainConfig, parm *GamePreCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawGamePreMatchTx(cfg *types.TuringchainConfig, parm *GamePreMatchTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawGamePreCancelTx(cfg *types.TuringchainConfig, parm *GamePreCancelTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameCancel{
...
func CreateRawGamePreCloseTx(cfg *types.TuringchainConfig, parm *GamePreCloseTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameClose{
