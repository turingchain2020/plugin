...
import (
	...
	_ "github.com/turingchain2020/plugin/plugin/crypto/init"
	"github.com/turingchain2020/plugin/plugin/dapp/cert/authority"
	"github.com/turingchain2020/plugin/plugin/dapp/cert/authority/utils"
	ct "github.com/turingchain2020/plugin/plugin/dapp/cert/types"
	pkt "github.com/turingchain2020/plugin/plugin/dapp/collateralize/types"
...
func initEnv() (*execEnv, error) {
	cfg := types.NewTuringchainConfig(types.ReadFile("./test/turingchain.toml"))
