...
import (
	...
	"github.com/turingchain2020/plugin/plugin/dapp/cert/authority/tools/cryptogen/generator"
	"github.com/spf13/cobra"
)

const (
	// CONFIGFILENAME 配置文件名
	CONFIGFILENAME = "turingchain.cryptogen.yaml"
	// OUTPUTDIR 证书文件输出路径
...
var (
	cmd = &cobra.Command{
		...
		Short: "turingchain crypto tool for generating key and certificate",
		Run:   generate,
	}
