...
func validTitle(cfg *types.TuringchainConfig, title string) bool {
	if cfg.IsPara() {
...
func checkCommitInfo(cfg *types.TuringchainConfig, commit *pt.ParacrossNodeStatus) error {
	if commit == nil {
...
func makeDoneReceipt(cfg *types.TuringchainConfig, execMainHeight, execHeight int64, commit *pt.ParacrossNodeStatus,
...
func paraCheckSelfConsOn(cfg *types.TuringchainConfig, db dbm.KV, commit *pt.ParacrossNodeStatus) (bool, *types.Receipt, error) {
...
func isHaveCrossTxs(cfg *types.TuringchainConfig, status *pt.ParacrossNodeStatus) bool {
...
func (a *action) assetTransferMainCheck(cfg *types.TuringchainConfig, transfer *types.AssetsTransfer) error {
...
func (a *action) assetWithdrawMainCheck(cfg *types.TuringchainConfig, withdraw *types.AssetsWithdraw) error {
