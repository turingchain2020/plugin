...
// NewType method
func NewType(cfg *types.TuringchainConfig) *LotteryType {
	c := &LotteryType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawLotteryCreateTx(cfg *types.TuringchainConfig, parm *LotteryCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryBuyTx(cfg *types.TuringchainConfig, parm *LotteryBuyTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryDrawTx(cfg *types.TuringchainConfig, parm *LotteryDrawTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawLotteryCloseTx(cfg *types.TuringchainConfig, parm *LotteryCloseTx) (*types.Transaction, error) {
	if parm == nil {
