...
import (
	...
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common/crypto"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common/crypto/blake2b"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common/crypto/bls12381"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common/crypto/bn256"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/params"

	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/model"
...
// PrecompiledContractsByzantium turingchain平台支持君士坦丁堡版本支持的所有预编译合约指令，并从此版本开始同步支持EVM黄皮书中的新增指令；
