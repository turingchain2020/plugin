...
import (
	...
	evm "github.com/turingchain2020/plugin/plugin/dapp/evm/executor"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common"
	crypto2 "github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/common/crypto"
	"github.com/turingchain2020/plugin/plugin/dapp/evm/executor/vm/runtime"
...
var chainTestCfg = types.NewTuringchainConfig(strings.Replace(types.GetDefaultCfgstring(), "Title=\"local\"", "Title=\"turingchain\"", 1))
