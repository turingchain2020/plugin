...
import (
	...
	commonlog "github.com/turingchain2020/turingchain/common/log"
	...
	pty "github.com/turingchain2020/plugin/plugin/dapp/guess/types"
...
func TestJRPCChannel(t *testing.T) {
	...
	testCases := []struct {
		fn func(*testing.T, *types.TuringchainConfig, *jsonclient.JSONClient) error
	}{
...
func testStartRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
	...
	var res string
	return jrpc.Call("Turingchain.CreateTransaction", params, &res)
}

func testBetRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testStopBetRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testPublishRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
...
func testAbortRawTxCmd(t *testing.T, cfg *types.TuringchainConfig, jrpc *jsonclient.JSONClient) error {
