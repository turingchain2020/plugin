...
import (
	...
	pty "github.com/turingchain2020/plugin/plugin/dapp/hashlock/types"
...
func hashlockLockCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "Turingchain.CreateTransaction", paramWithExecAction, nil)
