...
import (
	...
	"github.com/turingchain2020/plugin/plugin/dapp/js/types/jsproto"
)
...
var (
	...
	ErrInvalidFuncFormat = errors.New("turingchain.js: invalid function name format")
	//ErrInvalidFuncPrefix not exec_ execloal_ query_
	ErrInvalidFuncPrefix = errors.New("turingchain.js: invalid function prefix format")
	//ErrFuncNotFound 函数没有找到
	ErrFuncNotFound = errors.New("turingchain.js: invalid function name not found")
	ErrSymbolName   = errors.New("turingchain.js: ErrSymbolName")
	ErrExecerName   = errors.New("turingchain.js: ErrExecerName")
	ErrDBType       = errors.New("turingchain.js: ErrDBType")
	// ErrJsCreator
...
func NewType(cfg *types.TuringchainConfig) *JsType {
	c := &JsType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
