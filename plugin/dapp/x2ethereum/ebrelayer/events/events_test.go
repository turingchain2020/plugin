...
func Test_NewEventWrite(t *testing.T) {
	...
	assert.Equal(t, EventRecords["1"].Symbol, "trc")
}

func Test_NewTuringchainMsg(t *testing.T) {
	_ = NewTuringchainMsg(MsgBurn, []byte("12qyocayNF7Lv6C9qW4avxs2E7U41fKSfv"), common.HexToAddress("0x0C05bA5c230fDaA503b53702aF1962e08D0C60BF"),
		"eth", big.NewInt(100000000000000000), common.HexToAddress("0x0000000000000000000000000000000000000000"))
}

func Test_TuringchainMsgAttributeKey(t *testing.T) {
	assert.Equal(t, UnsupportedAttributeKey.String(), "unsupported")
	assert.Equal(t, TuringchainSender.String(), "turingchain_sender")
