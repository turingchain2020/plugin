...
import (
	...
	bridgeRegistry "github.com/turingchain2020/plugin/plugin/dapp/x2ethereum/ebrelayer/ethcontract/generated"
...
const (
	...
	BridgeBank
	// TuringchainBridge : turingchainBridge contract
	TuringchainBridge
)

// String : returns the event type as a string
func (d ContractRegistry) String() string {
	return [...]string{"valset", "oracle", "bridgebank", "turingchainbridge", "notsupport"}[d-1]
}
...
func GetAddressFromBridgeRegistry(client ethinterface.EthClientSpec, sender, registry common.Address, target ContractRegistry) (address *common.Address, err error) {
	...
	case TuringchainBridge:
		turingchainBridgeAddress, err := registryInstance.TuringchainBridge(&auth)
		if err != nil {
			log.Fatal(err)
		}
		return &turingchainBridgeAddress, nil
	default:
