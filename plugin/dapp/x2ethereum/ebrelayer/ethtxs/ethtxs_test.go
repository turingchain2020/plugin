...
func Test_LoadABI(t *testing.T) {
	abi1 := LoadABI(TuringchainBankABI)
	abi2 := LoadABI(TuringchainBridgeABI)
...
func TestContractRegistry_String(t *testing.T) {
	...
	assert.Equal(t, TuringchainBridge.String(), "turingchainbridge")
}
...
func Test_RelayOracleClaimToEthereum(t *testing.T) {
	...
	privateKeySlice, err := turingchainCommon.FromHex("0x3fa21584ae2e4fd74db9b58e2386f5481607dfa4d7ba0617aaa7858e5025dc1e")
	require.Nil(t, err)
	...
	prophecyClaim := ProphecyClaim{
		ClaimType:            events.MsgBurn,
		TuringchainSender:        []byte("12qyocayNF7Lv6C9qW4avxs2E7U41fKSfv"),
	...
	turingchainTxHash := common.Hex2Bytes("fd5747c43d1460bb6f8a7a26c66b4ccab5500d05668278efe5c0fd5951dfd909")
	txhash, err := RelayOracleClaimToEthereum(x2EthContracts.Oracle, sim, para.InitValidators[0], claimType, prophecyClaim, privateKey, turingchainTxHash)
	require.Nil(t, err)
