...
SRC_EBCLI=github.com/turingchain2020/plugin/plugin/dapp/x2ethereum/ebcli
SRC_EBRELAYER=github.com/turingchain2020/plugin/plugin/dapp/x2ethereum/ebrelayer
OUT_DIR="${1}/$strapp"
FLAG=$2
