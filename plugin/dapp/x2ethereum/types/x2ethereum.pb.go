...
type X2EthereumAction struct {
	...
	//	*X2EthereumAction_Eth2TuringchainLock
	//	*X2EthereumAction_Eth2TuringchainBurn
	//	*X2EthereumAction_TuringchainToEthBurn
	//	*X2EthereumAction_TuringchainToEthLock
...
type X2EthereumAction_Eth2TuringchainLock struct {
	Eth2TuringchainLock *Eth2Turingchain `protobuf:"bytes,1,opt,name=eth2TuringchainLock,proto3,oneof"`
}

type X2EthereumAction_Eth2TuringchainBurn struct {
	Eth2TuringchainBurn *Eth2Turingchain `protobuf:"bytes,2,opt,name=eth2TuringchainBurn,proto3,oneof"`
}

type X2EthereumAction_TuringchainToEthBurn struct {
	TuringchainToEthBurn *TuringchainToEth `protobuf:"bytes,3,opt,name=turingchainToEthBurn,proto3,oneof"`
}

type X2EthereumAction_TuringchainToEthLock struct {
	TuringchainToEthLock *TuringchainToEth `protobuf:"bytes,4,opt,name=turingchainToEthLock,proto3,oneof"`
}
...
func (*X2EthereumAction_Eth2TuringchainLock) isX2EthereumAction_Value() {}

func (*X2EthereumAction_Eth2TuringchainBurn) isX2EthereumAction_Value() {}

func (*X2EthereumAction_TuringchainToEthBurn) isX2EthereumAction_Value() {}

func (*X2EthereumAction_TuringchainToEthLock) isX2EthereumAction_Value() {}
...
func (m *X2EthereumAction) GetEth2TuringchainLock() *Eth2Turingchain {
	if x, ok := m.GetValue().(*X2EthereumAction_Eth2TuringchainLock); ok {
		return x.Eth2TuringchainLock
	}
	return nil
}

func (m *X2EthereumAction) GetEth2TuringchainBurn() *Eth2Turingchain {
	if x, ok := m.GetValue().(*X2EthereumAction_Eth2TuringchainBurn); ok {
		return x.Eth2TuringchainBurn
	}
	return nil
}

func (m *X2EthereumAction) GetTuringchainToEthBurn() *TuringchainToEth {
	if x, ok := m.GetValue().(*X2EthereumAction_TuringchainToEthBurn); ok {
		return x.TuringchainToEthBurn
	}
	return nil
}

func (m *X2EthereumAction) GetTuringchainToEthLock() *TuringchainToEth {
	if x, ok := m.GetValue().(*X2EthereumAction_TuringchainToEthLock); ok {
		return x.TuringchainToEthLock
	}
	return nil
}
...
func (*X2EthereumAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*X2EthereumAction_Eth2TuringchainLock)(nil),
		(*X2EthereumAction_Eth2TuringchainBurn)(nil),
		(*X2EthereumAction_TuringchainToEthBurn)(nil),
		(*X2EthereumAction_TuringchainToEthLock)(nil),
...
type Eth2Turingchain struct {
	...
	TuringchainReceiver       string   `protobuf:"bytes,8,opt,name=TuringchainReceiver,proto3" json:"TuringchainReceiver,omitempty"`
...
func (m *Eth2Turingchain) Reset()         { *m = Eth2Turingchain{} }
func (m *Eth2Turingchain) String() string { return proto.CompactTextString(m) }
func (*Eth2Turingchain) ProtoMessage()    {}
func (*Eth2Turingchain) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd1834a817ceb21, []int{3}
}

func (m *Eth2Turingchain) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Eth2Turingchain.Unmarshal(m, b)
}
func (m *Eth2Turingchain) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Eth2Turingchain.Marshal(b, m, deterministic)
}
func (m *Eth2Turingchain) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Eth2Turingchain.Merge(m, src)
}
func (m *Eth2Turingchain) XXX_Size() int {
	return xxx_messageInfo_Eth2Turingchain.Size(m)
}
func (m *Eth2Turingchain) XXX_DiscardUnknown() {
	xxx_messageInfo_Eth2Turingchain.DiscardUnknown(m)
}

var xxx_messageInfo_Eth2Turingchain proto.InternalMessageInfo

func (m *Eth2Turingchain) GetEthereumChainID() int64 {
	if m != nil {
...
func (m *Eth2Turingchain) GetBridgeContractAddress() string {
	if m != nil {
...
func (m *Eth2Turingchain) GetNonce() int64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *Eth2Turingchain) GetIssuerDotSymbol() string {
	if m != nil {
...
func (m *Eth2Turingchain) GetTokenContractAddress() string {
	if m != nil {
...
func (m *Eth2Turingchain) GetEthereumSender() string {
	if m != nil {
...
func (m *Eth2Turingchain) GetTuringchainReceiver() string {
	if m != nil {
		return m.TuringchainReceiver
	}
	return ""
}

func (m *Eth2Turingchain) GetValidatorAddress() string {
	if m != nil {
...
func (m *Eth2Turingchain) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *Eth2Turingchain) GetClaimType() int64 {
	if m != nil {
		return m.ClaimType
	}
	return 0
...
func (m *Eth2Turingchain) GetDecimals() int64 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
type OracleClaimContent struct {
	TuringchainReceiver      string   `protobuf:"bytes,1,opt,name=TuringchainReceiver,proto3" json:"TuringchainReceiver,omitempty"`
...
func (m *OracleClaimContent) GetTuringchainReceiver() string {
	if m != nil {
		return m.TuringchainReceiver
	}
	return ""
...
type TuringchainToEth struct {
	TokenContract        string   `protobuf:"bytes,1,opt,name=TokenContract,proto3" json:"TokenContract,omitempty"`
	TuringchainSender        string   `protobuf:"bytes,2,opt,name=TuringchainSender,proto3" json:"TuringchainSender,omitempty"`
...
func (m *TuringchainToEth) Reset()         { *m = TuringchainToEth{} }
func (m *TuringchainToEth) String() string { return proto.CompactTextString(m) }
func (*TuringchainToEth) ProtoMessage()    {}
func (*TuringchainToEth) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd1834a817ceb21, []int{5}
}

func (m *TuringchainToEth) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TuringchainToEth.Unmarshal(m, b)
}
func (m *TuringchainToEth) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TuringchainToEth.Marshal(b, m, deterministic)
}
func (m *TuringchainToEth) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TuringchainToEth.Merge(m, src)
}
func (m *TuringchainToEth) XXX_Size() int {
	return xxx_messageInfo_TuringchainToEth.Size(m)
}
func (m *TuringchainToEth) XXX_DiscardUnknown() {
	xxx_messageInfo_TuringchainToEth.DiscardUnknown(m)
}

var xxx_messageInfo_TuringchainToEth proto.InternalMessageInfo

func (m *TuringchainToEth) GetTokenContract() string {
	if m != nil {
...
func (m *TuringchainToEth) GetTuringchainSender() string {
	if m != nil {
		return m.TuringchainSender
	}
	return ""
}

func (m *TuringchainToEth) GetEthereumReceiver() string {
	if m != nil {
...
func (m *TuringchainToEth) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *TuringchainToEth) GetIssuerDotSymbol() string {
	if m != nil {
		return m.IssuerDotSymbol
	}
	return ""
...
func (m *TuringchainToEth) GetDecimals() int64 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
// 回执接口定义
type ReceiptEth2Turingchain struct {
	EthereumChainID       int64    `protobuf:"varint,1,opt,name=EthereumChainID,proto3" json:"EthereumChainID,omitempty"`
	BridgeContractAddress string   `protobuf:"bytes,2,opt,name=BridgeContractAddress,proto3" json:"BridgeContractAddress,omitempty"`
	Nonce                 int64    `protobuf:"varint,3,opt,name=Nonce,proto3" json:"Nonce,omitempty"`
	IssuerDotSymbol       string   `protobuf:"bytes,4,opt,name=IssuerDotSymbol,proto3" json:"IssuerDotSymbol,omitempty"`
...
func (m *ReceiptEth2Turingchain) Reset()         { *m = ReceiptEth2Turingchain{} }
func (m *ReceiptEth2Turingchain) String() string { return proto.CompactTextString(m) }
func (*ReceiptEth2Turingchain) ProtoMessage()    {}
func (*ReceiptEth2Turingchain) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd1834a817ceb21, []int{6}
}

func (m *ReceiptEth2Turingchain) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReceiptEth2Turingchain.Unmarshal(m, b)
}
func (m *ReceiptEth2Turingchain) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReceiptEth2Turingchain.Marshal(b, m, deterministic)
}
func (m *ReceiptEth2Turingchain) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReceiptEth2Turingchain.Merge(m, src)
}
func (m *ReceiptEth2Turingchain) XXX_Size() int {
	return xxx_messageInfo_ReceiptEth2Turingchain.Size(m)
}
func (m *ReceiptEth2Turingchain) XXX_DiscardUnknown() {
	xxx_messageInfo_ReceiptEth2Turingchain.DiscardUnknown(m)
}

var xxx_messageInfo_ReceiptEth2Turingchain proto.InternalMessageInfo

func (m *ReceiptEth2Turingchain) GetEthereumChainID() int64 {
	if m != nil {
		return m.EthereumChainID
	}
	return 0
...
func (m *ReceiptEth2Turingchain) GetBridgeContractAddress() string {
	if m != nil {
		return m.BridgeContractAddress
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetNonce() int64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *ReceiptEth2Turingchain) GetIssuerDotSymbol() string {
	if m != nil {
		return m.IssuerDotSymbol
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetTokenAddress() string {
	if m != nil {
...
func (m *ReceiptEth2Turingchain) GetEthereumSender() string {
	if m != nil {
		return m.EthereumSender
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetTuringchainReceiver() string {
	if m != nil {
		return m.TuringchainReceiver
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetValidatorAddress() string {
	if m != nil {
		return m.ValidatorAddress
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetClaimType() int64 {
	if m != nil {
		return m.ClaimType
	}
	return 0
...
func (m *ReceiptEth2Turingchain) GetXTxHash() []byte {
	if m != nil {
		return m.XTxHash
	}
	return nil
...
func (m *ReceiptEth2Turingchain) GetXHeight() uint64 {
	if m != nil {
		return m.XHeight
	}
	return 0
...
func (m *ReceiptEth2Turingchain) GetProphecyID() string {
	if m != nil {
		return m.ProphecyID
	}
	return ""
...
func (m *ReceiptEth2Turingchain) GetDecimals() int64 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
type ReceiptTuringchainToEth struct {
	TokenContract        string   `protobuf:"bytes,1,opt,name=TokenContract,proto3" json:"TokenContract,omitempty"`
	TuringchainSender        string   `protobuf:"bytes,2,opt,name=TuringchainSender,proto3" json:"TuringchainSender,omitempty"`
	EthereumReceiver     string   `protobuf:"bytes,3,opt,name=EthereumReceiver,proto3" json:"EthereumReceiver,omitempty"`
	Amount               string   `protobuf:"bytes,4,opt,name=Amount,proto3" json:"Amount,omitempty"`
...
func (m *ReceiptTuringchainToEth) Reset()         { *m = ReceiptTuringchainToEth{} }
func (m *ReceiptTuringchainToEth) String() string { return proto.CompactTextString(m) }
func (*ReceiptTuringchainToEth) ProtoMessage()    {}
func (*ReceiptTuringchainToEth) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd1834a817ceb21, []int{7}
}

func (m *ReceiptTuringchainToEth) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReceiptTuringchainToEth.Unmarshal(m, b)
}
func (m *ReceiptTuringchainToEth) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReceiptTuringchainToEth.Marshal(b, m, deterministic)
}
func (m *ReceiptTuringchainToEth) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReceiptTuringchainToEth.Merge(m, src)
}
func (m *ReceiptTuringchainToEth) XXX_Size() int {
	return xxx_messageInfo_ReceiptTuringchainToEth.Size(m)
}
func (m *ReceiptTuringchainToEth) XXX_DiscardUnknown() {
	xxx_messageInfo_ReceiptTuringchainToEth.DiscardUnknown(m)
}

var xxx_messageInfo_ReceiptTuringchainToEth proto.InternalMessageInfo

func (m *ReceiptTuringchainToEth) GetTokenContract() string {
	if m != nil {
		return m.TokenContract
	}
	return ""
...
func (m *ReceiptTuringchainToEth) GetTuringchainSender() string {
	if m != nil {
		return m.TuringchainSender
	}
	return ""
...
func (m *ReceiptTuringchainToEth) GetEthereumReceiver() string {
	if m != nil {
		return m.EthereumReceiver
	}
	return ""
...
func (m *ReceiptTuringchainToEth) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *ReceiptTuringchainToEth) GetIssuerDotSymbol() string {
	if m != nil {
		return m.IssuerDotSymbol
	}
	return ""
...
func (m *ReceiptTuringchainToEth) GetDecimals() int64 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Eth2Turingchain)(nil), "types.Eth2Turingchain")
	proto.RegisterType((*OracleClaimContent)(nil), "types.OracleClaimContent")
	proto.RegisterType((*TuringchainToEth)(nil), "types.TuringchainToEth")
	proto.RegisterType((*ReceiptEth2Turingchain)(nil), "types.ReceiptEth2Turingchain")
	proto.RegisterType((*ReceiptTuringchainToEth)(nil), "types.ReceiptTuringchainToEth")
