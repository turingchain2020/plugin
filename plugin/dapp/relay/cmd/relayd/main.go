...
import (
	...
	"github.com/turingchain2020/plugin/plugin/dapp/relay/cmd/relayd/relayd"
)

var (
	cpuNum            = runtime.NumCPU()
	configPath        = flag.String("f", "relayd.toml", "configfile")
	turingchainConfigPath = flag.String("turingchainflie", "", "turingchainconfigfile")
)
...
func main() {
	...
	if *turingchainConfigPath != "" {
		cfg.TuringchainCfg = types.NewTuringchainConfig(types.ReadFile(*turingchainConfigPath))
	}
