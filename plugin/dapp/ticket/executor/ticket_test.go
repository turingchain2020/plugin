...
import (
	...
	_ "github.com/turingchain2020/plugin/plugin/consensus/init"
	_ "github.com/turingchain2020/plugin/plugin/dapp/ticket"
)

var mock33 *testnode.TuringchainMock
...
func createBindMiner(t *testing.T, cfg *types.TuringchainConfig, m, r string, priv crypto.PrivKey) *types.Transaction {
...
func ticketList(t *testing.T, mock33 *testnode.TuringchainMock, req proto.Message) *ty.ReplyTicketList {
