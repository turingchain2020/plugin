...
func requestMainBlocks(cfg *types.TuringchainConfig, inv *inventory) (*types.ParaTxDetails, error) {
...
func requestMainBlockWithTime(cfg *types.TuringchainConfig, inv *inventory) *types.ParaTxDetails {
