...
func createConn(url string) (*grpc.ClientConn, types.TuringchainClient, error) {
	var err error
	//url := "127.0.0.1:9672"
	...
	c1 := types.NewTuringchainClient(conn)
...
func sendRegistCandidatorTx(cfg *types.TuringchainConfig, ppubkey, addr, ip, privKey string) bool {
