...
func TestMakeGenesisValidatorMgr(t *testing.T) {
	...
	require.Nil(t, err)
	assert.True(t, vMgr.ChainID == "turingchain-Z2cgFj")
	...
	vMgrCopy := vMgr.Copy()
	assert.True(t, vMgrCopy.ChainID == "turingchain-Z2cgFj")
