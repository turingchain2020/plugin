...
import (
	...
	mavl "github.com/turingchain2020/turingchain/system/store/mavl/db"
...
func New(cfg *types.Store, sub []byte, turingchaincfg *types.TuringchainConfig) queue.Module {
	...
	// 读取fork高度
	if turingchaincfg != nil {
		kvmvccMavlFork = turingchaincfg.GetDappFork("store-kvmvccmavl", "ForkKvmvccmavl")
	}
	delMavlDataHeight = kvmvccMavlFork + 10000
	bs.SetChild(kvms)
	return kvms
