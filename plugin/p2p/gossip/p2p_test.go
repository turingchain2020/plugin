...
import (
	...
	"github.com/turingchain2020/turingchain/p2p/utils"
	...
	l "github.com/turingchain2020/turingchain/common/log"
...
//new p2p
func newP2p(cfg *types.TuringchainConfig, port int32, dbpath string, q queue.Queue) *P2p {
...
func testPeer(t *testing.T, p2p *P2p, q queue.Queue) {
	cfg := types.NewTuringchainConfig(types.ReadFile("../../../turingchain.toml"))
